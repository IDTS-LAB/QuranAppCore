            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/route.HealthzResponse"
                        }
                    },
                    "503": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application.LogoutRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/application.MeResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application.VerifyEmailRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "application.LoginResponse": {
            ...
            "properties": {
                ...
                "expires_at": {
                    "description": "ExpiresAt is when the access token stops being valid. Clients should\nuse the refresh token to get a new pair before then.",
                    "type": "string"
                },
                "refresh_token": {
                    "type": "string"
        ...
        "application.VerifyEmailRequest": {
            "type": "object",
            "required": [
                "token"
            ],
        ...
        "http.RegisterResponse": {
            ...
            "properties": {
                "data": {},
                "error": {
                    "$ref": "#/definitions/http.RegisterError"
                },
                "message": {
                    "type": "string",
        ...
        "route.HealthzResponse": {
            ...
            "properties": {
                ...
                "error": {
                    "$ref": "#/definitions/route.HealthzError"
                },
                "message": {
                    "type": "string",
                    "example": "ok"
